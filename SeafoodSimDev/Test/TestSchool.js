...
var TestSchool = (function () {
    function TestSchool() {
        ...
        //var singleCod: Cod = new Cod(1, 1, startPosition, sce);
        //var singleMackerel: Mackerel = new Mackerel(1, 1, startPosition, sce);
        //var gov: Government = new Government(new Restrictions(sce), sce);
        //var map: Map = new Map(gov.getRestrictions(), sce);
        ...
        //    testCod = new Cod(1, 1, startPosition, sce);
        //    assert.ok(testCod);
