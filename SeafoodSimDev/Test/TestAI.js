var TestAI = (function () {
    function TestAI(p_scenario) {
        var ai = new AI(p_scenario);
        var gov = new Government(new Restrictions(p_scenario), p_scenario);
        var map = new Map(gov.getRestrictions(), p_scenario);
        var richShipOwner = new ShipOwner(gov, new Point2(0, 0), "0", p_scenario, 10000000000000000000);
        var poorShipOwner = new ShipOwner(gov, new Point2(0, 0), "1", p_scenario, -10000000000000000000);
