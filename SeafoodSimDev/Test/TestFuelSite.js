var TestFuelSite = (function () {
    function TestFuelSite() {
        var fuelSite = new FuelSite(1, 100, 10, 1, "0", new Point2(0, 0));
        ...
        QUnit.test("FuelSite: restock", function (assert) {
            ...
            var fuelAtsite = fuelSite.getResourceAtSite();
            fuelSite.restock();
        ...
        QUnit.test("FuelSite: provide fuel", function (assert) {
            ...
            var amountProvided = fuelSite.provideFuel(50);
...
//# sourceMappingURL=TestFuelSite.js.map